...
const u8 gText_PickOK[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}OK {SELECT_BUTTON}LAST VIEWED");
...
const u8 gOtherText_Select[] = _("SELECT");
const u8 gOtherText_L[] = _("L BUTTON");
const u8 gOtherText_R[] = _("R BUTTON");
...
const u8 gText_ShopAlreadyBought[] = _("You already have this item.");
const u8 gText_ShopAlreadyBoughtWait[] = _("You already have this item.\p");
const u8 gText_ShopAlreadyBoughtEntry[] = _("IN BAG");
...
const u8 gText_50Coins_1000[] = _("{FONT_SMALL} 50 COINS{CLEAR_TO 0x5C}¥200");
const u8 gText_500Coins_10000[] = _("{FONT_SMALL}500 COINS{CLEAR_TO 0x52}¥2,000");
...
const u8 gText_Tm13_InBag[] = _("TM13{CLEAR_TO 0x61}{FONT_SMALL}IN BAG");
const u8 gText_Tm23_InBag[] = _("TM23{CLEAR_TO 0x61}{FONT_SMALL}IN BAG");
const u8 gText_Tm24_InBag[] = _("TM24{CLEAR_TO 0x61}{FONT_SMALL}IN BAG");
const u8 gText_Tm30_InBag[] = _("TM30{CLEAR_TO 0x61}{FONT_SMALL}IN BAG");
const u8 gText_Tm35_InBag[] = _("TM35{CLEAR_TO 0x61}{FONT_SMALL}IN BAG");
...
const u8 gText_Eevee_5500Coins[] = _("EEVEE{CLEAR_TO 0x4B}{FONT_SMALL} 5,500 COINS");
...
const u8 gText_PokeSum_Mode[] = _("{COLOR 13}MODE");
const u8 gText_PokeSum_IV[] = _("{COLOR 13}IV");
const u8 gText_PokeSum_EV[] = _("{COLOR 13}EV");
...
const u8 gText_BattleScene[] = _("BATTLE ANIMATIONS");
...
const u8 gText_ButtonTypeLEqualsA[] = _("ON (L=A)");
const u8 gText_ButtonTypeLR[] = _("OFF");
...
const u8 gText_StopLearningMove[] = _("Continue learning {STR_VAR_2}?");
...
const u8 gText_GiveUpTryingToTeachNewMove[] = _("Continue trying to teach a new\nmove to {STR_VAR_1}?");
