...
#define OPEN_BAG_HELDITEMS 1
#define OPEN_BAG_ITEMS     2
#define OPEN_BAG_KEYITEMS  3
#define OPEN_BAG_POKEBALLS 4
#define OPEN_BAG_LAST      5
...
#define ITEMMENUACTION_SELECT_BUTTON  11
#define ITEMMENUACTION_L_BUTTON       12
#define ITEMMENUACTION_R_BUTTON       13
