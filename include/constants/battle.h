...
#define B_WIN_MOVE_STATS_UPPER_LEFT     7
#define B_WIN_MOVE_STATS_LOWER_RIGHT    8
#define B_WIN_MOVE_STATS_UPPER_RIGHT    9
#define B_WIN_MOVE_STATS_LOWER_LEFT     10
...
#define B_WIN_MOVE_STATS_CATEGORY       25
